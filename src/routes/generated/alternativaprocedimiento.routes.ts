...
const routes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.get<{
    ...
    try {
      ...
      const alternativaProcedimiento = await prisma.alternativaProcedimiento.findUnique({
        where: { id }
      });
  ...
  fastify.post<{
    ...
    try {
      const { expedienteId, procedimiento, puntuacion, justificacion } = request.body;
      ...
      const alternativaProcedimiento = await prisma.alternativaProcedimiento.create({
        data: {
          expedienteId,
  ...
  fastify.put<{
    ...
    try {
      ...
      const existingAlternativaProcedimiento = await prisma.alternativaProcedimiento.findUnique({
        where: { id }
      });
      ...
      const updatedAlternativaProcedimiento = await prisma.alternativaProcedimiento.update({
        where: { id },
        data: {
          ...updateData,
