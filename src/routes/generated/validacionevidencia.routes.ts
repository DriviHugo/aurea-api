...
const routes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.put('/:id', {
    ...
    try {
      ...
      const newValidacionId = updateData.validacionId || existingValidacionEvidencia.validacionId;
      const newEvidenciaId = updateData.evidenciaId || existingValidacionEvidencia.evidenciaId;

      if (newValidacionId !== existingValidacionEvidencia.validacionId || 
