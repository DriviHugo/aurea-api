...
const routes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.put('/:id', {
    ...
    try {
      ...
      if (body.functionCode !== undefined) updateData.functionCode = body.functionCode;
      if (body.functionName !== undefined) updateData.functionName = body.functionName;
      ...
      if (body.inputVariables !== undefined) updateData.inputVariables = body.inputVariables;
