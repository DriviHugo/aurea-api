...
const routes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.post('/', {
    ...
    try {
      const data = request.body as {
        nombre: string;
        tipo?: 'openai' | 'anthropic' | 'google' | 'azure' | 'custom';
        baseUrl: string;
      ...
      const aiProvider = await prisma.aiProvider.create({
        data: {
          ...
          apiKeySecretName: data.apiKeySecretName || null,
          modelosDisponibles: data.modelosDisponibles || [],
          parametrosDefecto: data.parametrosDefecto || {}
        }
      });
  ...
  fastify.put('/:id', {
    ...
    try {
      ...
      if (data.apiKeySecretName !== undefined) updateData.apiKeySecretName = data.apiKeySecretName;
      if (data.modelosDisponibles !== undefined) updateData.modelosDisponibles = data.modelosDisponibles;
      if (data.parametrosDefecto !== undefined) updateData.parametrosDefecto = data.parametrosDefecto;
