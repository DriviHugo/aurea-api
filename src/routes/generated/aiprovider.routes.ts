    ...
    async (request, reply) => {
      try {
        ...
        if (data.apiKeySecretName !== undefined)
          updateData.apiKeySecretName = data.apiKeySecretName;
        if (data.modelosDisponibles !== undefined)
          updateData.modelosDisponibles = data.modelosDisponibles;
        if (data.parametrosDefecto !== undefined)
          updateData.parametrosDefecto = data.parametrosDefecto;
