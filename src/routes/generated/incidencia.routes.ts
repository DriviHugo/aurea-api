  ...
  fastify.put(
    ...
    async (request, reply) => {
      try {
        ...
        if (data.funcionalidad !== undefined)
          updateData.funcionalidad = data.funcionalidad;
        if (data.descripcion !== undefined)
          updateData.descripcion = data.descripcion;
        if (data.comportamientoEsperado !== undefined)
          updateData.comportamientoEsperado = data.comportamientoEsperado;
