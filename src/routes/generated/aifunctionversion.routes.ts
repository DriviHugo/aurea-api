...
const routes: FastifyPluginAsync = async (fastify) => {
  ...
  // POST /ai-function-versions - Create
  fastify.post('/', {
    preValidation: [fastify.authAccessToken],
    schema: {
      tags: ['AI Function Versions'],
  ...
  // PUT /ai-function-versions/:id - Update
  fastify.put('/:id', {
    preValidation: [fastify.authAccessToken],
    schema: {
      tags: ['AI Function Versions'],
    ...
    try {
      ...
      const aiFunctionVersion = await prisma.aiFunctionVersion.update({
        where: { id },
        data
      });
  ...
  // DELETE /ai-function-versions/:id - Delete
  fastify.delete('/:id', {
    preValidation: [fastify.authAccessToken],
    schema: {
      tags: ['AI Function Versions'],
