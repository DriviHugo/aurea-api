  ...
  fastify.put('/:id', {
    ...
    try {
      ...
      if (updateData.documentoId || updateData.evidenciaId) {
        const documentoId = updateData.documentoId || existingDocumentoEvidencia.documentoId;
        const evidenciaId = updateData.evidenciaId || existingDocumentoEvidencia.evidenciaId;
