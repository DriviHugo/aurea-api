...
const caseSchema = {
  ...
  properties: {
    ...
    emergencyOperationalRoute: {
      type: "string",
      nullable: true,
      enum: [...EMERGENCY_ROUTE_VALUES, null],
    },
    emergencyReasons: {
      type: "array",
    ...
    deliveryType: {
      type: "string",
      nullable: true,
      enum: [...DELIVERY_TYPE_VALUES, null],
    },
    ...
    deliveryFrequency: {
      type: "string",
      nullable: true,
      enum: [...DELIVERY_FREQUENCY_VALUES, null],
    },
    deliveryLocationMode: {
      type: "string",
      nullable: true,
      enum: [...DELIVERY_LOCATION_MODE_VALUES, null],
    },
    deliveryLocations: {
      type: "array",
      nullable: true,
    ...
    innovationLevel: {
      type: "string",
      nullable: true,
      enum: [...INNOVATION_LEVEL_VALUES, null],
    },
    includesIDPhases: { type: "boolean" },
    centralizationNotApplicableReason: {
      type: "string",
      nullable: true,
      enum: [...CENTRALIZATION_NOT_APPLICABLE_REASON_VALUES, null],
    },
