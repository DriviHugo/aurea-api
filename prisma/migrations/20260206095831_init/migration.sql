...
-- CreateEnum
CREATE TYPE "EstadoExpediente" AS ENUM ('ingesta', 'borrador', 'alternativas', 'en_redaccion', 'validado', 'aprobado', 'revision', 'incidencia', 'con_observaciones', 'listo_validacion', 'en_intervencion', 'cerrado');

-- CreateEnum
CREATE TYPE "TipoContrato" AS ENUM ('obras', 'servicios', 'suministros', 'concesion_obras', 'concesion_servicios', 'mixto');

-- CreateEnum
CREATE TYPE "TipoProcedimiento" AS ENUM ('abierto', 'abierto_simplificado', 'abierto_supersimplificado', 'restringido', 'negociado_sin_publicidad', 'negociado_con_publicidad', 'dialogo_competitivo', 'asociacion_innovacion', 'menor');
...
-- AddForeignKey
ALTER TABLE "expedientes" ADD CONSTRAINT "expedientes_creador_id_fkey" FOREIGN KEY ("creador_id") REFERENCES "profiles"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "reglas" ADD CONSTRAINT "reglas_aprobador_id_fkey" FOREIGN KEY ("aprobador_id") REFERENCES "profiles"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "documentos" ADD CONSTRAINT "documentos_creador_id_fkey" FOREIGN KEY ("creador_id") REFERENCES "profiles"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "validaciones" ADD CONSTRAINT "validaciones_usuario_id_fkey" FOREIGN KEY ("usuario_id") REFERENCES "profiles"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "revisiones" ADD CONSTRAINT "revisiones_usuario_id_fkey" FOREIGN KEY ("usuario_id") REFERENCES "profiles"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "comentarios" ADD CONSTRAINT "comentarios_usuario_id_fkey" FOREIGN KEY ("usuario_id") REFERENCES "profiles"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "audit_log" ADD CONSTRAINT "audit_log_usuario_id_fkey" FOREIGN KEY ("usuario_id") REFERENCES "profiles"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ai_function_versions" ADD CONSTRAINT "ai_function_versions_creado_por_fkey" FOREIGN KEY ("creado_por") REFERENCES "profiles"("id") ON DELETE SET NULL ON UPDATE CASCADE;
